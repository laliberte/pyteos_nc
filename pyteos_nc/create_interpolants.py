...
class Interpolated_data:
    def __init__(self,realm,input_type,func_name,thermo_axes,thermo_data):
        ...
        if input_type in ['h','g','g_ref'] and 'rh_wmo' in thermo_axes.keys():
        ...
        if input_type=='sat':
            ...
            self._interpolants=interp_linear_3D((thermo_axes[moisture_var],thermo_axes['eta'],thermo_axes['p'],thermo_data))
